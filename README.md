...
- Origin list: [Martyr2's Mega Project List](https://www.dreamincode.net/forums/topic/78802-martyr2s-mega-project-ideas-list/)
- Project: [miguelgazela/Projects](https://github.com/miguelgazela/Projects)

| Symbol                  | Description         | Symbol                 | Description                     |
| :----:                  | :----------         | :----:                 | :----------                     |
| :bulb:                  | from origin list    | :1234:                 | Numbers section                 |
| :bookmark:              | from project        | :capital_abcd:         | Text section                    |
| :ballot_box_with_check: | done                | :globe_with_meridians: | Networking section              |
| :construction:          | in progress         | :package:              | Classes section                 |
| :page_facing_up:        | link to source code | :bar_chart:            | Threading section               |
| :memo:                  | link to license     | :surfer:               | Web section                     |
| :book:                  | link to readme      | :file_folder:          | Files section                   |
| :star:                  | easy                | :ticket:               | Databases section               |
| :star::star:            | normal              | :space_invader:        | Graphics and Multimedia section |
| :star::star::star:      | hard                | :video_game:           | Games section                   |
|                         |                     | :computer:             | Classic Algorithms section      |
|                         |                     | :repeat:               | Graphs section                  |
...
<table class="tg">
  <tr>
    ...
    <th class="tg-c3ow"><span style="font-weight:bold">Number</span></th>
  ...
  <tr>
    <td class="tg-c3ow">Pig Latin</td>
    <td class="tg-c3ow"><span style="font-weight:bold">0x0421</span></td>
    <td class="tg-14gg">0</td>
    <td class="tg-14gg">0</td>
    <td class="tg-14gg">0</td>
    <td class="tg-14gg">0</td>
    <td class="tg-zljd">0</td>
    <td class="tg-zljd">1</td>
    <td class="tg-zw9b">0</td>
    <td class="tg-gekp">0</td>
    <td class="tg-gekp">0</td>
    <td class="tg-gekp">0</td>
    <td class="tg-gekp">1</td>
    <td class="tg-kfkg">0</td>
    <td class="tg-kfkg">0</td>
    <td class="tg-kfkg">0</td>
    <td class="tg-kfkg">0</td>
...
| 0x0024 | Count Words in a String                    | :capital_abcd:         | :bulb:     | :construction:          |                                                   |            |
...
+ **Forty Days of Dating Scraper** - A small script that fetches date from the [fortydaysofdating.com](http://fortydaysofdating.com) website and opens a new tab on the default browser as soon as a new post is posted.
...
+ **Josephus Problem** - Create a program which links together various node objects and then every Nth object is removed until you have one object left. This last object is the sole survivor. Look it up on Google under "[Josephus Algorithm](https://en.wikipedia.org/wiki/Josephus_problem)".
...
+ **Text Based Game Like Utopia** - Create a simple text based RPG like Utopia where you can create a civilization, gather resources, forge alliances, case spells and more on a turn based system. See if you can dominate the kingdom.
...
+ **Content Management System** - Create a content management system (CMS) like Joomia, Drupal, PHP Nuke etc. Start small and allow for the addition of modules/addons later.
...
+ **Sort File Records Utility** - Reads a file of records, sorts them, and then writes them back to the file. Allow the user to choose various sort style and sorting based on particular field.
...
+ **Budget Tracker** - Write an application that keeps track of household's budget. The user can add expenses, income, and recurring costs to find out how much they are saving or losing over a period of time. For added complexity allow the user to specify a date range and see the new flow of money in and out of the house budget for that time period.
...
+ **Hangman** - Randomly select a word from a file, have the user guess characters in the word. For each character they guess that is not in the word, have it draw another part of a man hanging in a noose. If the picture is completed before they guess all the characters, they close.

+ **Crossword Puzzle** - Create a crossword puzzle which links word together on common letters. Provide a list of clues for each word and let the user enter fill in the words until the entire crossword is filled in.
